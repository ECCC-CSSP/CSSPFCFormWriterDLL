...
namespace CSSPFCFormWriterDLL.Services
{
    public partial class CSSPFCFormWriter
    {
        private void FillTableRow(TableRow tableRow, int index, int SheetNumber)
        {
            ...
            int A1MeasurementListCount = labSheetA1Sheet.LabSheetA1MeasurementList.Where(c => c.SampleType != SampleTypeEnum.DailyDuplicate).Count();
            int DailyDuplicateIndex = -1;
            if (labSheetA1Sheet.LabSheetA1MeasurementList.Where(c => c.SampleType == SampleTypeEnum.DailyDuplicate).Count() > 0)
            {
                DailyDuplicateIndex = labSheetA1Sheet.LabSheetA1MeasurementList.Count - 1;
            }
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Site != null)
                {
                    text136.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Site.ToString();
                }
                else
                {
                    text136.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].SampleType == SampleTypeEnum.IntertechDuplicate)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -1)
                    {
                        text139.Text = "Int. D";
                    }
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -2)
                    {
                        text139.Text = "RLog";
                    }
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -3)
                    {
                        text139.Text = "PCrit";
                    }
                }
                else if (labSheetA1Sheet.LabSheetA1MeasurementList[index].SampleType == SampleTypeEnum.IntertechRead)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -4)
                    {
                        text139.Text = "Int. R";
                    }
                }
                ...
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Time.HasValue)
                    {
                        text139.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Time.Value.ToString("HH:mm");
                    }
                    else
                    {
                        text139.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].SampleType == SampleTypeEnum.IntertechDuplicate)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -1)
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN == 1700)
                        {
                            text142.Text = "> 1600";
                        }
                        else if (labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN == 1)
                        {
                            text142.Text = "< 2";
                        }
                        else
                        {
                            text142.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN.ToString();
                        }
                    }
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -2)
                    {
                        text142.Text = ((float)(labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN) / 1000000.0f).ToString("F5");
                    }
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].TVItemID == -3)
                    {
                        text142.Text = ((float)(labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN) / 1000000.0f).ToString("F5");
                ...
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN.HasValue)
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN.Value == 1)
                        {
                            text142.Text = "< 2";
                        }
                        else if (labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN.Value == 1700)
                        {
                            text142.Text = "> 1600";
                        }
                        else
                        {
                            text142.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].MPN.Value.ToString();
                        }
                    }
                    else
                    {
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Tube10.HasValue)
                {
                    text145.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Tube10.Value.ToString();
                }
                else
                {
                    text145.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Tube1_0.HasValue)
                {
                    text148.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Tube1_0.Value.ToString();
                }
                else
                {
                    text148.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Tube0_1.HasValue)
                {
                    text151.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Tube0_1.Value.ToString();
                }
                else
                {
                    text151.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Salinity.HasValue)
                {
                    text154.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Salinity.Value.ToString("F1");
                }
                else
                {
                    text154.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].Temperature.HasValue)
                {
                    text158.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].Temperature.Value.ToString("F1");
                }
                else
                {
                    text158.Text = "";
            ...
            if (A1MeasurementListCount > index)
            {
                if (labSheetA1Sheet.LabSheetA1MeasurementList[index].ProcessedBy != null)
                {
                    text162.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index].ProcessedBy.ToString();
                }
                else
                {
                    text162.Text = "";
            ...
            if (index < 14 || (SheetNumber == 2 && (index - 34) < 14) || (SheetNumber == 3 && (index - 68) < 14) || (SheetNumber == 4 && (index - 102) < 14) || (SheetNumber == 5 && (index - 136) < 14))
            {
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Site != null)
                    {
                        text166.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Site.ToString();
                    }
                    else
                    {
                        text166.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].SampleType == SampleTypeEnum.IntertechDuplicate)
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -1)
                        {
                            text169.Text = "Int. D";
                        }
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -2)
                        {
                            text169.Text = "RLog";
                        }
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -3)
                        {
                            text169.Text = "PCrit";
                        }
                    }
                    else if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].SampleType == SampleTypeEnum.IntertechRead)
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -4)
                        {
                            text169.Text = "Int. R";
                        }
                    }
                    ...
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Time.HasValue)
                        {
                            text169.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Time.Value.ToString("HH:mm");
                        }
                        else
                        {
                            text169.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].SampleType == SampleTypeEnum.IntertechDuplicate)
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -1)
                        {
                            if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN == 1700)
                            {
                                text172.Text = "> 1600";
                            }
                            else if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN == 1)
                            {
                                text172.Text = "< 2";
                            }
                            else
                            {
                                text172.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN.ToString();
                            }
                        }
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -2)
                        {
                            text172.Text = ((float)(labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN) / 1000000.0f).ToString("F5");
                        }
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].TVItemID == -3)
                        {
                            text172.Text = ((float)(labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN) / 1000000.0f).ToString("F5");
                    ...
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN.HasValue)
                        {
                            if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN.Value == 1)
                            {
                                text172.Text = "< 2";
                            }
                            else if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN.Value == 1700)
                            {
                                text172.Text = "> 1600";
                            }
                            else
                            {
                                text172.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].MPN.Value.ToString();
                            }
                        }
                        else
                        {
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Tube10.HasValue)
                    {
                        text175.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Tube10.Value.ToString();
                    }
                    else
                    {
                        text175.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Tube1_0.HasValue)
                    {
                        text178.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Tube1_0.Value.ToString();
                    }
                    else
                    {
                        text178.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Tube0_1.HasValue)
                    {
                        text181.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Tube0_1.Value.ToString();
                    }
                    else
                    {
                        text181.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Salinity.HasValue)
                    {
                        text184.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Salinity.Value.ToString();
                    }
                    else
                    {
                        text184.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Temperature.HasValue)
                    {
                        text188.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].Temperature.Value.ToString();
                    }
                    else
                    {
                        text188.Text = "";
                ...
                if (A1MeasurementListCount > (index + 20))
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].ProcessedBy != null)
                    {
                        text192.Text = labSheetA1Sheet.LabSheetA1MeasurementList[index + 20].ProcessedBy;
                    }
                    else
                    {
                        text192.Text = "";
            ...
            else if (index == 14 || (SheetNumber == 2 && (index - 34) == 14) || (SheetNumber == 3 && (index - 68) == 14) || (SheetNumber == 4 && (index - 102) == 14) || (SheetNumber == 5 && (index - 136) == 14))
            {
                ...
                runProperties192.Append(fontSizeComplexScript259);
                Text text192 = new Text();
                text192.Text = "Sheet " + SheetNumber + " of " + (A1MeasurementListCount > 34 ? (A1MeasurementListCount > 68 ? (A1MeasurementListCount > 102 ? (A1MeasurementListCount > 136 ? "5" : "4") : "3") : "2") : "1");
            ...
            else if (index == 15 || (SheetNumber == 2 && (index - 34) == 15) || (SheetNumber == 3 && (index - 68) == 15) || (SheetNumber == 4 && (index - 102) == 15) || (SheetNumber == 5 && (index - 136) == 15))
            {
                ...
                if (DailyDuplicateIndex > 0)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Site != null)
                    {
                        text213.Text = labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Site;
                    }
                    else
                    {
                        text213.Text = "";
                ...
                if (DailyDuplicateIndex > 0)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].ProcessedBy != null)
                    {
                        text217.Text = labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].ProcessedBy;
                    }
                    else
                    {
                        text217.Text = "";
                ...
                if (DailyDuplicateIndex > 0)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].MPN.HasValue)
                    {
                        if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].MPN.Value == 1)
                        {
                            text220.Text = "< 2";
                        }
                        else if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].MPN.Value == 1700)
                        {
                            text220.Text = "> 1600";
                        }
                        else
                        {
                            text220.Text = labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].MPN.Value.ToString();
                        }
                    }
                    else
                    {
                ...
                if (DailyDuplicateIndex > 0)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Tube10.HasValue)
                    {
                        text223.Text = labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Tube10.Value.ToString();
                    }
                    else
                    {
                        text223.Text = "";
                ...
                if (DailyDuplicateIndex > 0)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Tube1_0.HasValue)
                    {
                        text226.Text = labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Tube1_0.Value.ToString();
                    }
                    else
                    {
                        text226.Text = "";
                ...
                if (DailyDuplicateIndex > 0)
                {
                    if (labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Tube0_1.HasValue)
                    {
                        text229.Text = labSheetA1Sheet.LabSheetA1MeasurementList[DailyDuplicateIndex].Tube0_1.Value.ToString();
                    }
                    else
                    {
                        text229.Text = "";
                ...
                if (!(string.IsNullOrWhiteSpace(labSheetA1Sheet.ResultsReadYear) || string.IsNullOrWhiteSpace(labSheetA1Sheet.ResultsReadMonth) || string.IsNullOrWhiteSpace(labSheetA1Sheet.ResultsReadDay)))
                {
                    ...
                    {
                        DateTime DateTimeDuplicateDataEntryDate = new DateTime(int.Parse(labSheetA1Sheet.ResultsReadYear), int.Parse(labSheetA1Sheet.ResultsReadMonth), int.Parse(labSheetA1Sheet.ResultsReadDay));
                        text233.Text = labSheetA1Sheet.ResultsReadBy + "      " + DateTimeDuplicateDataEntryDate.ToString("yyyy MMMM dd");
                    }
                }
            ...
            else if (index == 16 || index == 17 || (SheetNumber == 2 && (index - 34) == 16) || (SheetNumber == 2 && (index - 34) == 17) || (SheetNumber == 3 && (index - 68) == 16) || (SheetNumber == 3 && (index - 68) == 17) || (SheetNumber == 4 && (index - 102) == 16) || (SheetNumber == 4 && (index - 102) == 17) || (SheetNumber == 5 && (index - 136) == 16) || (SheetNumber == 5 && (index - 136) == 17))
            {
            ...
            else if (index == 18 || (SheetNumber == 2 && (index - 34) == 18) || (SheetNumber == 3 && (index - 68) == 18) || (SheetNumber == 4 && (index - 102) == 18) || (SheetNumber == 5 && (index - 136) == 18))
            {
                ...
                text313.Text = labSheetA1Sheet.DailyDuplicateRLog;
                ...
                text317.Text = labSheetA1Sheet.DailyDuplicatePrecisionCriteria;
                ...
                text321.Text = labSheetA1Sheet.DailyDuplicateAcceptableOrUnacceptable;
            ...
            else if (index == 19 || (SheetNumber == 2 && (index - 34) == 19) || (SheetNumber == 3 && (index - 68) == 19) || (SheetNumber == 4 && (index - 102) == 19) || (SheetNumber == 5 && (index - 136) == 19))
            {
